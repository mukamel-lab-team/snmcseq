...
def merge_allc(allc_paths, output_fname, 
	context='CG', chunksize=100000, n_chunk1=50, n_chunk2=20, path_allcg=GENOME_ALLCG_FILE): 
	"""
...
if __name__ == '__main__':
	...
	# allc_paths = natsorted(glob.glob(os.path.join(PATH_DATASETS, 'MB_v1', 'allc', '*')))[:2]
	# merge_allc(allc_paths, 'test_allc_merge.tsv', 
	# 	context='CG', chunksize=100000, n_chunk1=50, n_chunk2=20, path_allcg=GENOME_ALLCG_FILE) 
