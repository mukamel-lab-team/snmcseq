...
CONVENTION = 'human' # 'CEMBA' or 'human'
...
PATH_CEMBA = '/cndd/Public_Datasets/human_snmcseq'
PATH_PROJECT = PATH_CEMBA

PATH_DATASETS = PATH_CEMBA + '/Datasets'
PATH_ENSEMBLES = PATH_CEMBA + '/Ensembles'
PATH_REFERENCES = PATH_CEMBA + '/References'
PATH_GENEBODY_ANNOTATION = PATH_REFERENCES + '/Annotation/gencode.v19.annotation_genes.tsv'
GENEBODY = PATH_GENEBODY_ANNOTATION # for back-compatibility
GENOME_SIZE_FILE = PATH_REFERENCES + '/Genome/hg19.chrom.sizes'
GENOME_ALLCG_FILE = PATH_REFERENCES + '/Genome/hg19_all_cg.tsv'
