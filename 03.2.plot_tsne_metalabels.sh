...
do
input=./data/tsne/tsne_perp${perplexity}_binc_mCHmCG_human_combined_100000_summary_nmcc_v2.tsv
metadata=./data/metadata/metadata_human_combined_updated.tsv
 output=./results/tsne/tsne_perp${perplexity}_biosample_nmCHnmCG_binc_100000.pdf
./plot_tsne_metalabels.py -i $input -m $metadata -l 'Biosample' -o $output --title "tSNE of MB_v1, MB_EA, and MB_EB (mCH & mCG 100kb bins, perplexity: $perplexity)" --legend_mode 0  
done 

# human 1,2,3 mCG
for perplexity in 10 15 20 25 30 50 100 150 200 250 300 500
do
input=./data/tsne/tsne_perp${perplexity}_binc_mCG_human_combined_100000_summary_nmcc_v2.tsv
metadata=./data/metadata/metadata_human_combined_updated.tsv
