...
from gen_gene_cell_mc_c_matrix import gen_gene_cell_mc_c_matrix

metadata = '/cndd/fangming/side_project/snmcseq_dev/metadata/human_MB_EB_metadata_cells.tsv'
input_matrix = '/cndd/Public_Datasets/single_cell_methylome/gene_level/human/genebody_mCG_hs2.mat'
output_dir = '/cndd/Public_Datasets/single_cell_methylome/gene_level/human/genebody_mCG_hs2_by_gene'
context = 'CG'
