...
# global mCH 
./plot_tsne_metavalues.py -i ./data/tsne/tsne_perp50_binc_mCHmCG_human_combined_100000_summary_normalized.tsv -m ./data/metadata/metadata_human_combined_updated.tsv -l 'mCH/CH' -o ./results/tsne/tsne_perp50_human_combined_global_mCH.pdf -t 'human samples global mCH' -s

# global mCG 
./plot_tsne_metavalues.py -i ./data/tsne/tsne_perp50_binc_mCHmCG_human_combined_100000_summary_normalized.tsv -m ./data/metadata/metadata_human_combined_updated.tsv -l 'mCG/CG' -o ./results/tsne/tsne_perp50_human_combined_global_mCG.pdf -t 'human samples global mCG' -s
