...
do
./tsne.py -i ./data/binc/binc_mCHmCG_human_combined_100000_summary_nmcc_v3.tsv -o ./data/tsne/tsne_perp${perplexity}_binc_mCHmCG_human_combined_100000_summary_nmcc_v3.tsv --perplexity ${perplexity} 
done
...
# for perplexity in 10 15 20 25 30 50 75 100 150 200 250 300
# do
# ./tsne.py -i ./data/binc/binc_mCG_human_combined_100000_summary_nmcc_v3.tsv -o ./data/tsne/tsne_perp${perplexity}_binc_mCG_human_combined_100000_summary_nmcc_v3.tsv --perplexity ${perplexity} 
# done
# 
# # MB_v1 MB_EA MB_EB  mCH bins 
# for perplexity in 10 15 20 25 30 50 75 100 150 200 250 300
# do
# ./tsne.py -i ./data/binc/binc_mCH_human_combined_100000_summary_nmcc_v3.tsv -o ./data/tsne/tsne_perp${perplexity}_binc_mCH_human_combined_100000_summary_nmcc_v3.tsv --perplexity ${perplexity} 
# done
# 
