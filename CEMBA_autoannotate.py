...
def auto_annotate_worker(cluster_f, input_f, 
    ...
    Args:
        - input_f: path to a gziped/bgziped 100kb bin raw methylation counts 
            - columns: ['chr', 'bin', 'sample_mc', 'sample_c', ...]
        - cluster_f: path to a cluster assignment 
            - columns: ['sample', 'cluster_ID']
    """
    ti = time.time()
